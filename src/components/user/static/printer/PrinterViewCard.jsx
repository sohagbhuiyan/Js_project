...
import { addPrinterToCart } from "../../../../store/static/printerSlice";
import { addToCompare } from "../../../../store/compareSlice";
import toast, { Toaster } from "react-hot-toast";
import QuickViewModal from "../../product/QuickViewModal";

const PrinterViewCard = ({
  id,
  imagea,
  category,
  name,
  ...
  const cartStatus = useSelector((state) => state.printers.status);
  const cartError = useSelector((state) => state.printers.error);
  ...
  return (
    <>
      <Link to={`/printer/${id}`} style={{ textDecoration: "none" }} onClick={handleProductClick}>
        <div
      ...
      <QuickViewModal
        ...
        product={{ id, imagea, category, name, type, regularprice, specialprice }}
      />
...
export default PrinterViewCard;
