...
const CameraViewCard = ({
  ...
  return (
    <>
      <Link to={`/camera/${id}`} style={{ textDecoration: "none" }} onClick={handleProductClick}>
        <div
      ...
      <QuickViewModal
        ...
        product={{ id, imagea, category, name, totalpixel, regularprice, specialprice }}
      />
